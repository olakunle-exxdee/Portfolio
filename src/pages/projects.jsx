...
const projects = [
  ...
  },
  {
    ...
    description:
      'The new album from Elevation Worship & Maverick City, New album: Old Church Basement.',
    link: { href: 'https://elevate-worship.netlify.app', label: 'Elevate' },
...
export default function Projects() {
  return (
    <>
      <Head>
        <title>Projects - Saheed Ogunsolu</title>
        <meta
          name="description"
          content="Things I’ve made trying to put my dent in the universe."
        />
      </Head>
      <SimpleLayout title="Project">
        <ul
          role="list"
